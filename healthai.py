...
Original file is located at
    https://colab.research.google.com/drive/1cfncHRpOUeAvUO1L7wvM2Dz6EK0tZuUv
"""

!pip install transformers torch gradio -q

!pip install gradio transformers accelerate torch --upgrade
...
# If needed, set token = "your_HF_token_here"
...
def disease_prediction(symptoms):
    ...
    and general medication suggestions.
    Symptoms: {symptoms}
...
def treatment_plan(condition, age, gender, medical_history):
    ...
    Emphasize consulting healthcare professionals for proper treatment."""
    return generate_response(prompt, max_length=1200)
